...
print('Exercise 4: Convert 0°C to Fahrenheit:', convert_temperature(0, 'C'))  # Should print 32.0
print('Exercise 4: Convert 32°F to Celsius:', convert_temperature(32, 'F'))   # Should print 0.0
